    ...
    <>
      {landlord && (
        <div className="flex flex-col gap-2">
          ...
          <textarea name="message" className="w-full border p-3 rounded-lg" id="message" rows="2" value={message} onChange={onChange} placeholder="Enter your message here..."></textarea>
